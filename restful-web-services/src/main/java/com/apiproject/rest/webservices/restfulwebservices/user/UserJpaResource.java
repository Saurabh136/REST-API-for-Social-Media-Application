...
import com.apiproject.rest.webservices.restfulwebservices.jpa.PostRepository;
import com.apiproject.rest.webservices.restfulwebservices.jpa.UserRepository;
...
public class UserJpaResource {
	...
	public ResponseEntity<Object> createPostForUser(@PathVariable int id,@Valid @RequestBody Post post) {
	    ...
	    URI location = ServletUriComponentsBuilder.fromCurrentRequest().pathSegment("/{id}").buildAndExpand(savedPost.getId()).toUri();
		//location - /users/5 (whenever we POST an new user we will get the URL location of it
